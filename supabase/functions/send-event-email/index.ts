    ...
    <tr>
      <td align="center" style="padding: 30px 15px;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 580px; background-color: #0B0F19; border: 1px solid #1E293B; border-radius: 16px; overflow: hidden; box-shadow: 0 20px 40px rgba(0,0,0,0.6);">
          <!-- Header Branding -->
          <tr>
            <td style="padding: 24px 32px 20px; border-bottom: 1px solid #1E293B; background: linear-gradient(180deg, #131B2E 0%, #0B0F19 100%);">
              <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  ...
                  <td align="right" valign="middle">
                    <span style="display: inline-block; padding: 5px 12px; border-radius: 20px; font-size: 11px; font-weight: 700; font-family: monospace; background-color: ${badgeColor}22; color: ${badgeColor}; border: 1px solid ${badgeColor}55; letter-spacing: 0.5px; text-transform: uppercase;">
                      ${badgeText}
                    </span>
                  </td>
                </tr>
